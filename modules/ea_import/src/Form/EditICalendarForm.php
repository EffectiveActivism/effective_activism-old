...
/**
 * @file
 * Contains \Drupal\ea_import\Form\EditICalendarForm.
 */
 ...
 * ICalendar form.
 */
class EditICalendarForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormID() {
    return 'ea_import_edit_icalendar';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, Grouping $grouping = NULL, $icalendar = NULL) {
    ...
    $form['import']['filters']['description'] = array(
      ...
      '#maxlength' => 255,
      '#required' => FALSE,
      '#default_value' => $icalendar->description,
    );
