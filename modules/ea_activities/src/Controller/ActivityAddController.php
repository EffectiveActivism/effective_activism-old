...
namespace Drupal\ea_activities\Controller;
 ...
 *
 * @package Drupal\ea_activities\Controller
 */
class ActivityAddController extends ControllerBase {
   ...
   *   The storage for the Activity entity.
   * @param EntityStorageInterface $type_storage
   *   The storage for the Activity type.
   */
   ...
   *
   * @return array
   *   A render array for a list of the activity bundles/types that
