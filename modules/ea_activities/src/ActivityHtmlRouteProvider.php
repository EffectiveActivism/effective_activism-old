...
/**
 * @file
 * Contains \Drupal\ea_activities\ActivityHtmlRouteProvider.
 */
...
class ActivityHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\ea_activities\Controller\ActivityAddController::addForm',
          '_title_callback' => 'Drupal\ea_activities\Controller\ActivityAddController::getAddFormTitle',
        ])
